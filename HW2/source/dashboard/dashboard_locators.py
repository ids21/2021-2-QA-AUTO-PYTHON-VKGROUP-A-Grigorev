...
class CampaignLocator:
    ...
    DELETE_RECORD = "//ul[@data-test='select_list']/li[@data-id='8']"
...
class AudienceLocator:
    ...
    RECORD_SEGEMTS = "//div[@role='rowgroup']//div[contains(@class,'cells')]/a[contains(text(),'{}')]"
    FIELD_INPUT_NAME= "//div[contains(@class,'input_create-segment')]//input"
